...
export const AlbumsCarousel: React.FC<AlbumsCarouselProps> = ({
  ...
  return (
    <div className="albums-carousel-wrapper">
      <div
        ref={carouselRef}
        className={`albums-carousel ${isDragging ? 'dragging' : ''} ${isScrolling ? 'scrolling' : ''}`}
      ...
      >
        {albums.map((album, index) => (
          <div
            ...
            role="group"
            aria-label={`Album ${index + 1} of ${albums.length}: ${album.title} by ${album.artist}`}
